...
$APPLICATION->SetPageProperty("title", "Тарифы на расчётные счета без платы за открытие счета для ИП и ООО #CITY_FORM_6#");
...
?><? $APPLICATION->IncludeComponent(
    ...
    <div id="content-bank-ajax">
        ...
        $GLOBALS['arFilter'] = [
            ...
            'PROPERTY_PROPERTY_ACCOUNT_PAYMENT' => 'бесплатно',
        ];
        ?>
        <?$APPLICATION->IncludeComponent(
            "bitrix:news.list",
