    ...
    <div class="col-md-24">
        <div class="bank-table-container-wrapper">
            ...
            <div class="bank-table-container">
                <table class="bank-table bank-table_fixed">
                    <thead>
                    <tr>
                        ...
                        <?foreach($tariffData as $tariff):?>
                            <?
                            if (
                                isset($tariff['PROPERTIES']['PROPERTY_NAME']['VALUE']) &&
                                !empty($tariff['PROPERTIES']['PROPERTY_NAME']['VALUE'])
                            ):?>
                                <th><?=$tariff['PROPERTIES']['PROPERTY_NAME']['VALUE']; ?></th>
                            <?else:?>
                                <th></th>
                            <?endif?>
                        <?endforeach?>
