...
Asset::getInstance()->addCss($templateFolder . '/styles/detail.css');

$app = App::getInstance();

$arTags = CIBlockElement::GetList([] , ['ID' => $ElementID] , false , false , ['TAGS'])->Fetch();


function renderVerticalBannerIfExists($iblockId, $elementId)
{
    $arOrder = [];
    $arFilter = ['CODE' => 'BANNER_VERTICAL'];
    $bannerVerticalProp = CIBlockElement::GetProperty($iblockId, $elementId, $arOrder, $arFilter)->Fetch();
...
$GLOBALS['arFilterArticles'] = ['!ID' => $ElementID];
if(!empty($arTags)){
    $tags = explode(',' , $arTags['TAGS']);
    $condition = implode(' | ' , $tags);
    $GLOBALS['arFilterArticles']['?TAGS'] = $condition;
}
?>
...
<div class="container content-article">
    <div class="content-article__row row">
        <div class="col-md-16 col-sm-24 col-xs-24 block-content-article">
            <?$APPLICATION->ShowViewContent('container-article-text')?>
        </div>

        <div class="col-xs-24 container visible-xs visible-sm">
            <div class="row">
                <div class="col-md-24">
        ...
        <div class="col-xs-24 container visible-xs visible-sm">
            ...
            ?>
            <?
            $GLOBALS['readAlsoFilter'] = ['!ID' => $ElementID];
            $APPLICATION->IncludeComponent(
                ...
                Array(
                    ...
                    "PROPERTY_CODE" => array(0=>"PROPERTY_DESCRIPTION",1=>"PROPERTY_HEADER",2=>"",),
                    "SET_BROWSER_TITLE" => "Y",
                    "SET_LAST_MODIFIED" => "N",
        ...
        <div class="col-md-8 col-sm-24 col-xs-24 article-aside">
            <div class="article-aside__content">
                <?renderVerticalBannerIfExists($arParams['IBLOCK_ID'], $ElementID)?>
                <?$APPLICATION->IncludeComponent(
                    "bitrix:news.list",
                    "article-list-item",
                    array(
    ...
    <span class="" onclick="print()">распечатать</span>
</div>
