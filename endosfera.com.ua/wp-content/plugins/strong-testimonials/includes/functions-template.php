...
function wpmtst_client_section( $client_section ) {
	...
	foreach ( $client_section as $field ) {
		...
		if ( $output ) {
			...
			if($field['class'] == 'name_post_coment'){
                $html .= '<cite class="comment__autor-name ' . $field['class'] . '">' . $output . '</cite>';
            }elseif($field['class'] == 'data_post_coment'){
                $html .= '<p class="comment__autor-time ' . $field['class'] . '">' . $output . '</p>';
            }elseif($field['class'] == 'pros_post_coment'){
                $GLOBALS['pros_post_coment'] = $output;
            }elseif($field['class'] == 'minus_post_coment'){
                $GLOBALS['minus_post_coment'] = $output;
            }elseif($field['class'] == 'rating_post_coment'){
                $GLOBALS['rating_post_coment'] = $output;
            }
		}
	}
