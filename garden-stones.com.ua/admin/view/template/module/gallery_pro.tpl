    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-gallery" class="form-horizontal">
          ...
          <div class="form-group">
              <label class="col-sm-2 control-label" for="input-loading_text_color"><?php echo $entry_loading_text_color; ?></label>
              <div class="col-sm-10">
          ...
          <div class="collapse titlevars" id="titlevariables1">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-thumb_title_font_color"><?php echo $entry_thumb_title_font_color; ?></label>
              <div class="col-sm-10">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-thumb_title_background_color"><?php echo $entry_thumb_title_background_color; ?></label>
              <div class="col-sm-10">
          ...
          <div class="collapse shadowvars" id="shadowvariables1">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-box_shadow_color"><?php echo $entry_box_shadow_color; ?></label>
              <div class="col-sm-10">
