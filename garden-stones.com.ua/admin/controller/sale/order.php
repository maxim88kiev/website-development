...
//			$data['total'] = $this->currency->format($order_info['total'], $order_info['currency_code'], $order_info['currency_value']);
			$data['total'] = $this->model_sale_order->getOrderTotals($this->request->get['order_id'])[0]['value'];
			...
			foreach ($products as $product) {
                ...
                $options_size = $this->model_sale_order->getOrderOptions_size($this->request->get['order_id'], $product['order_product_id']);
				...
				$data['products'][] = array(
					...
					'model'    		   => $product['model'],
					'option'   		   => $option_data,
                    'options_size'     => $options_size[0] ["option_product"],
					'quantity'		   => $product['quantity'],
