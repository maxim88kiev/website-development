<?php
class ControllerModuleampproductpro extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('module/amp_product_pro');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/amp_product_pro', 'token=' . $this->session->data['token'], 'SSL')
		);

		$data['action'] = $this->url->link('module/amp_product_pro', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('module/amp_product_pro.tpl', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'module/amp_product_pro')) {
