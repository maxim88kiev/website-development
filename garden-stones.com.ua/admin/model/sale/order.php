...
class ModelSaleOrder extends Model {
    ...
    public function getOrderOptions_size($order_id, $order_product_id) {
        $query = $this->db->query("SELECT option_product FROM " . DB_PREFIX . "order_product WHERE order_id = '" . (int)$order_id . "' AND order_product_id = '" . (int)$order_product_id . "'");
