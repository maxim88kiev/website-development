<h3 class="new-items_block_title"><?php echo $heading_title; ?></h3>
...
<div class="new-items_block">
  ...
  <div class="new-items_block_product">
    ...
    <?php } ?>
    <!--<button class="new-items_block_product_but" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');">
