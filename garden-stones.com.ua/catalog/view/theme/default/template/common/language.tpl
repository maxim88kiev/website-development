...
<div class="top_header_container_leng">
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="language">

  <ul class="top_header_container_leng_ul">
  <?php foreach ($languages as $language) { ?>
  <li class="<?php
  if($language_id == $language['code']){
    echo $language_id;
  }
   ?>"><a href="<?php echo $language['code']; ?>"><!--<img src="image/flags/<?php echo $language['image']; ?>" alt="<?php echo $language['name']; ?>" title="<?php echo $language['name']; ?>" />--> <?php echo $language['name']; ?></a></li>
  <?php } ?>
  </ul>
