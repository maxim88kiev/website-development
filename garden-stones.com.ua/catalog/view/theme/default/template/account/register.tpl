...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <p class="register_text"><?php echo $text_account_already; ?></p>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <?php if ($text_agree) { ?>
        <div class="buttons">
          <div class="pull-right buttons_text_reg"><?php echo $text_agree; ?>
            <?php if ($agree) { ?>
            ...
            <?php } ?>
            &nbsp;
            <input type="submit" value="<?php echo $button_continue; ?>" class="btn btn-primary pull-right_but_login" />
          </div>
        </div>
        <?php } else { ?>
        <div class="buttons">
