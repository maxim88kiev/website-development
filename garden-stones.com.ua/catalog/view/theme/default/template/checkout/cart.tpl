          ...
          <table class="table table-bordered">
            ...
            <tr>
              ...
              <td class="text-right"><?php
                  ...
                  if(!empty($product['option_param'])){
                    $product_price_option = array_sum($product['option_param']);
                    $product_price = $product['price'] - $product_price_option;
                  }
                  $product_price_total = 0;
                  asort($product['option_param']);
                  if($product['quantity'] >= 5 && $product['quantity'] < 21 ){
                  $product_price = $product['option_param'][0];
                  }elseif($product['quantity'] >= 21 && $product['quantity'] < 41 ){
                  $product_price = $product['option_param'][1];
                  }elseif($product['quantity'] >= 41 ){
                  $product_price = $product['option_param'][2];
                  }
                  echo $product_price;
                  $product_price_total = $product['quantity']*$product_price;
