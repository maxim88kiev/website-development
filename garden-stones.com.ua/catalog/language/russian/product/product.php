...
$_['text_write']                              = 'Написать отзыв о товаре';
...
$_['text_specification']                        = 'Общие характеристики';
$_['text_price_kg']                        = 'цена за 1 кг';
$_['text_price_one']                        = 'цена за 1 шт';

$_['text_wholesale']                        = 'Оптом и в розницу';
$_['text_bag']                        = 'В корзину отправляется цена за мешок';
$_['text_show_wholesale']                        = 'Показать оптовые цены';
$_['text_product_reviews']                        = 'Отзывы по товарам';
$_['text_advantages']                        = 'Достоинства';
$_['text_disadvantages']                        = 'Недостатки';
$_['text_important']                        = 'Важно! Чтобы Ваш отзыв либо комментарий прошел модерацию и был опубликован, ознакомьтесь, пожалуйста, с';