...
$_['title_payment_address']  						= 'Деталь платежа';
...
$_['title_payment_method'] 							= 'Способ оплати';
$_['description_payment_method'] 					= '';
$_['title_shopping_cart'] 							= 'Корзина';
$_['description_shopping_сart'] 					= '';
$_['text_login']                                    = 'Авторизуватися';


$_['placeholder_telephone'] 						= '050 123 45 54';

$_['error_field_required'] 							= "Це поле обов'язково для заповнення";
$_['error_valid_telephone'] 						= 'Please enter a valid telephone number';
$_['entry_email_confirm'] 							= 'Подтвердите электронный адрес';
$_['error_email_confirm'] 							= 'Подтверждение по электронной почте не соответствует электронной почте!';
$_['entry_fax'] 									= 'Fax:';
...
$_['error_step_confirm_fields_comment'] = 'Пожалуйста, заполните комментарий к заказу';
