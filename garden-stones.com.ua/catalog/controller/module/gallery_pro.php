...
class ControllerModuleGalleryPro extends Controller {
    ...
    $data['setting'] = $setting;     
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/gallery_pro.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/module/gallery_pro.tpl', $data);
		} else {
			return $this->load->view('default/template/module/gallery_pro.tpl', $data);
		}
	}
