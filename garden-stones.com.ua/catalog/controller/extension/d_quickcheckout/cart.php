    ...
    public function prepare($json){
        ...
        foreach ($products as $product) {
            ...
            if(!empty($option_param)){
                ...
                $product_price = $price - $product_price_option;
                asort($option_param);
				...
				if($option_price_kg[0] != 0){
					$option_param_kg_param = $this->language->get('option_param_kg_param') . $option_param_kg . " кг";
				}
...
//                    }
                ...
                $product_price_total = $product['quantity'] * $product_price * $option_name_param .'грн';
                $product_price = $product_price.$option_name_weight;
            }else{
                $product_price = round($price, 1).$option_name_weight;
                $product_price_total = round($total, 1) * $option_name_param . 'грн';
            }
            ...
            $json['products'][] = array(
                ...
                'model'     => $product['model'],
                'option'    => $option_data,
				//'option_one'    => $option_price_kg[0],
                'option_param_kg'    => $option_param_kg_param,
