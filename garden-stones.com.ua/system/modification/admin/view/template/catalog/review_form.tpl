      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
		  ...
		  <div class="form-group">
            <label class="col-sm-2 control-label" for="input-admin-author"><?php echo $entry_author_answer; ?></label>
            <div class="col-sm-10">
              <input type="text" name="admin_author" value="<?php echo $admin_author; ?>" placeholder="<?php echo $user_group; ?>" id="input-admin-author" class="form-control" />
			</div>
          </div>
          <div class="form-group">
		  ...
		  <div class="form-group">
			<label class="col-sm-2 control-label" for="input-date-available"><?php echo $entry_date_added; ?></label>
			<div class="col-sm-3">
