...
class ControllerCommonMenu extends Controller {
    ...
    $data['text_ocfilter_option'] = $this->language->get('text_ocfilter_option');
    ...
    $data['text_ocfilter_setting'] = $this->language->get('text_ocfilter_setting');
		...
		$data['information'] = $this->url->link('catalog/information', 'token=' . $this->session->data['token'], 'SSL');
 		...
 		// OCFilter start
		$data['ocfilter_option'] = $this->url->link('catalog/ocfilter', 'token=' . $this->session->data['token'], 'SSL');
    $data['ocfilter_page'] = $this->url->link('catalog/ocfilter_page', 'token=' . $this->session->data['token'], 'SSL');
    $data['ocfilter_setting'] = $this->url->link('module/ocfilter', 'token=' . $this->session->data['token'], 'SSL');
		// OCFilter end
