...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
            ...
            if($categories){
                $category_id_name = $this->model_catalog_category->getCategory($categories[0]['category_id']);
                $category_id_name = $this->model_catalog_category->getCategory($category_id_name);
            }
			...
			$data['tab_calculator'] = $this->language->get('tab_calculator');
            ...
            $data['text_price_kg'] = $this->language->get('text_price_kg');
            $data['text_price_one'] = $this->language->get('text_price_one');


            $data['text_wholesale'] = $this->language->get('text_wholesale');
            $data['text_bag'] = $this->language->get('text_bag');
            $data['text_show_wholesale'] = $this->language->get('text_show_wholesale');
            $data['text_product_reviews'] = $this->language->get('text_product_reviews');
            $data['text_advantages'] = $this->language->get('text_advantages');
            $data['text_disadvantages'] = $this->language->get('text_disadvantages');
            $data['text_important'] = $this->language->get('text_important');
            $data['text_specification'] = $this->language->get('text_specification');


            //$product_explod = explode("===", $product_info['description']);

            //$data['description_1'] = html_entity_decode($product_explod[0], ENT_QUOTES, 'UTF-8');

            //if(!empty($product_explod[1])){
                //$data['description_2'] = html_entity_decode($product_explod[1], ENT_QUOTES, 'UTF-8');
            //}
...
//				$data['thumb'] = $this->model_tool_image->resize($product_info['image'], $this->config->get('config_image_thumb_width'), $this->config->get('config_image_thumb_height'));
			...
			foreach ($this->model_catalog_product->getProductOptions($this->request->get['product_id']) as $option) {
                ...
                $meta_price = number_format($meta_price, 2, '.', '');
