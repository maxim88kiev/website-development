...
class __TwigTemplate_0aa2869103fd291382b2b9ca1ed61cfda91989d3de8738d7a8f8ad5b1cc8871b extends Twig_Template
{
  ...
  <form action=\"";
    ...
    <div class=\"btn-group\">
      <button class=\"btn btn-link dropdown-toggle\" data-toggle=\"dropdown\">";
            ...
            echo " <span class=\"hidden-xs hidden-sm hidden-md hidden-lg\">";
...
/*       {% endfor %} <span class="hidden-xs hidden-sm hidden-md hidden-lg">{{ text_currency }}</span>&nbsp;<i class="fa fa-caret-down"></i></button>*/
/*       <ul class="dropdown-menu">*/
