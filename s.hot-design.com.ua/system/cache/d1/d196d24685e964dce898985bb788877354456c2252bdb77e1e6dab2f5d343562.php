...
class __TwigTemplate_817b0b915b9e4998c3b609cbd0aa791db7e70bada08e0a8f7344b92955944fa9 extends Twig_Template
{
...
/*       {% endif %}*/
/*       {% endfor %}*/
/*       <span class="hidden-xs hidden-sm hidden-md hidden-lg">{{ text_language }}</span>&nbsp;<i class="fa fa-caret-down"></i></button>*/
/*       <ul class="dropdown-menu">*/
/*         {% for language in languages %}*/
/*         <li>*/
