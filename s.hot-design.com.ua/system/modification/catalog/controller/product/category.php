    ...
    if (isset($this->request->get['filter_ocfilter'])) {
      ...
      $filter_ocfilter = '';
		...
		if (isset($this->request->get['path'])) {
			...
			$data['category_id_statji'] = $category_id;
...
$this->document->addScript('catalog/view/javascript/jquery/jquery.images-rotation.js');
				...
				foreach($flips as $flip){
					$flip_images[] = array(
						'flipimage' => $this->model_tool_image->resize($flip['image'], $this->config->get('theme_' . $this->config->get('config_theme') . '_image_product_width'), $this->config->get('theme_' . $this->config->get('config_theme') . '_image_product_height')),
