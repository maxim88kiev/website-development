			...
			$url = explode('=', $query1->row['query']);
				unset($this->request->get['route']);
					...
					if ($url[0] == 'tmdblogcategory_id') {
						...
						$this->request->get['route'] = 'extension/tmdblog';
					}
			}
			/////////////// TMD blog SEO work 
	...
	public function rewrite($link) {
		...
		foreach ($data as $key => $value) {
			...
			/////////////////////xml
				...
				else if(($data['route'] == 'extension/blog' && $key == 'blog_id') || ($data['route'] == 'extension/tmdblog' && $key == 'tmdblogcategory_id'))
				{
					$url=str_replace('/extension/blog','',$url);
