<link rel="stylesheet" href="./controller/extension/module/slider-assets/popup.css">

<div class="eapps-deactivation-popup-overlay"></div>

<div class="eapps-deactivation-popup">
    <form method="post" id="slider-deactivateForm" action="">
        <div class="eapps-deactivation-popup-header">
            <div class="eapps-deactivation-popup-header-heading">You have succesfully uninstalled Elfsight Slider</div>
...
<script>
    ...
    node.async = true;
    node.src = './controller/extension/module/slider-assets/popup.js';
