...
$_['help_shop_folder']		= 'Если в домене Вашего магазина есть директория, например: https://prowebber.ru//shop/ то укажите название директории shop без знаков слэш /. Если же в домене вашего магазина нет директории, например https://prowebber.ru/ - то оставьте это поле пустым.';
...
// Error
$_['error_permission']    = 'У Вас нет прав для управления этим модулем! <a href="https://prowebber.ru/" target="_blank" title="ProWebber" style="color:#0362B6;margin-right:5px"><i class="fa fa-cloud-download fa-fw"></i></a> 
';
?>