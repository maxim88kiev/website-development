        ...
        var make = function () {
            ...
            function init(el, date, my_times, my_button, my_step, my_select, my_setDate, my_language) {
                ...
                if ($.trim(el.val()) == "" && my_setDate == '' || $.trim(el.val()) == "0000-00-00 00:00:00") {
                    ...
                    year = pr_d[2], month = parseInt(pr_d[1].replace(/^0+/, '')) - 1, day = parseInt(pr_d[0].replace(/^0+/, ''));
                    if (my_times == true) {
                        pr_t = pr_dt[1].split(':');
                ...
                for (var i = 1; i <= (dayCount + n_day); i++) {
                    ...
                    if (i > n_day) {
                        if (((i % 7) - 6) == 0 || i % 7 == 0) {
                            html += "<td><div class='no_chd'>" + (i - n_day) + "</div></td>";
                        } else if (year == date.getFullYear() && month == date.getMonth() && (i - n_day) == date.getDate()) {
            ...
            function init_2(el, date, my_times, my_button, my_step) {
                if (my_times == true) {
                    ...
                    el.next().find(".d_hour").on('change', function () {
                        ...
                        if ($.trim(el.val()) == "") {
                            el.val(el.next().find(".n_chd").text() + "." + ((parseInt(el.next().find(".d_month").val()) + 1) < 10 ? '0' : '') + (parseInt(el.next().find(".d_month").val()) + 1) + "." + (el.next().find(".n_chd").text() < 10 ? '0' : '') + el.next().find(".d_year").val() + d_hour);
                        } else {
                    ...
                    el.next().find(".d_minute").on('change', function () {
                        ...
                        if ($.trim(el.val()) == "") {
                            el.val((el.next().find(".n_chd").text() < 10 ? '0' : '') + el.next().find(".n_chd").text() + "." + ((parseInt(el.next().find(".d_month").val()) + 1) < 10 ? '0' : '') + (parseInt(el.next().find(".d_month").val()) + 1) + "." + el.next().find(".d_year").val() + d_minute);
                        } else {
                            el.val(el.val().replace(/\:[0-9]{2}/i, ":" + $(this).val()));
                        }
                    });
                ...
                if (my_button == true) {
                    ...
                    el.next().find(".t_button").on('click', function () {
                        ...
                        el.val((date.getDate() < 10 ? '0' : '') + date.getDate() + "." + ((parseInt(date.getMonth()) + 1) < 10 ? '0' : '') + (parseInt(date.getMonth()) + 1) + "." + date.getFullYear() + t_button);
                        el.next().html(init(el, date, my_times, my_button, my_step, my_select, my_setDate, my_language));
                ...
                el.next().find(".chd").on('click', function () {
                    ...
                    $(this).addClass('s_chd');
                    if (el.is('input')) {
                        el.val(($(this).text() < 10 ? '0' : '') + $(this).text() + "." + ((parseInt(el.next().find(".d_month").val()) + 1) < 10 ? '0' : '') + (parseInt(el.next().find(".d_month").val()) + 1) + "." + el.next().find(".d_year").val() + chd);
                    }
                });
                ...
                el.next().find(".d_year").on('change', function () {
                    ...
                    if ($.trim(el.val()) == "") {
                        el.val((d_chisl < 10 ? '0' : '') + d_chisl + "." + ((parseInt(el.next().find(".d_month").val()) + 1) < 10 ? '0' : '') + (parseInt(el.next().find(".d_month").val()) + 1) + "." + $(this).val() + d_year);
                    } else {
                        el.val(el.val().replace(/\.[0-9]{4}/i, "." + $(this).val()));
                    }
                ...
                el.next().find(".d_month").on('change', function () {
                    ...
                    if ($.trim(el.val()) == "") {
                        el.val((d_chisl < 10 ? '0' : '') + d_chisl + "." + ((parseInt($(this).val()) + 1) < 10 ? '0' : '') + (parseInt($(this).val()) + 1) + "." + el.next().find('.d_year').val() + d_month);
                    } else {
                        el.val(el.val().replace(/\.[0-9]{2}\./i, "." + ((parseInt($(this).val()) + 1) < 10 ? '0' : '') + (parseInt($(this).val()) + 1) + "."));
                    }
                ...
                el.next().find(".g_next").on('click', function () {
                    ...
                    if (g_g == el.next().find(".o_year:last").val() && g_m > 12) {
                        ...
                        el.next().find(".o_year[value=" + g_g + "]").prop("selected", true);
                    } else if (g_m > 12) {
                        g_m = 1;
                        //el.next().find(".o_year:contains('" + (g_g + 1) + "')").first().attr("selected", true);
                        el.next().find(".o_year[value=" + (g_g + 1) + "]").prop("selected", true);
                    }
                    ...
                    if ($.trim(el.val()) == "") {
                        el.val((el.next().find(".n_chd").text() < 10 ? '0' : '') + el.next().find(".n_chd").text() + "." + (g_m < 10 ? '0' : '') + g_m + "." + g_g + g_next);
                    } else {
                        el.val(el.val().replace(/\.[0-9]{2}\./i, "." + (g_m < 10 ? '0' : '') + g_m + "."));
                    }
                ...
                el.next().find(".g_back").on('click', function () {
                    ...
                    if ($.trim(el.val()) == "") {
                        el.val((el.next().find(".n_chd").text() < 10 ? '0' : '') + el.next().find(".n_chd").text() + "." + (g_m < 10 ? '0' : '') + g_m + "." + g_g + g_back);
                    } else {
                        el.val(el.val().replace(/\.[0-9]{2}\./i, "." + (g_m < 10 ? '0' : '') + g_m + "."));
                    }
