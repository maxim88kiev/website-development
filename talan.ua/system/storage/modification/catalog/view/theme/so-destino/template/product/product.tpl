...
<?php
	...
	if(strlen($html_product_shortdesc) >  30){
		...
		$product_description_short = "<div class='h3'>". $overview."</div>";
...
<!-- BREADCRUMB -->
<div class="breadcrumbs category_prod">
	<div class="container ">
...
<div class="content-main container product-detail <?php echo'product-'. $getColumn;?>">
    ...
    <div id="content" class="<?php echo $class; ?> product_content">
    	<?php if ($column_left || $column_right) { ?>
		...
		<?php } ?>
        <div class="row product-view product-info product-view-bg clearfix product_content-view" itemprop="offerDetails" itemscope itemtype="http://schema.org/Product">
			...
			?>
				<div class="content-product-left  <?php if(isset($thumbnails_position) && $thumbnails_position == 'bottom') echo "class-honizol"; ?> <?php echo $left_gallery; ?> ">
                    ...
                    <?php if ($images && isset($thumbnails_position) && $thumbnails_position == 'left') : ?>
                        <div id="thumb-slider" class="thumb-vertical-outer">
							...
							<ul class="thumb-vertical">
								...
								if ($images) : ?>
									<?php $i=-1; foreach ($images as $img_indx => $image) :$i++ ?>
									<li class="owl2-item">
										<a data-index="<?php echo $i; ?>" class="img thumbnail thumb_img" data-image="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?> - Фото-<?= ($img_indx + 1)?> Talan">
											<img src="<?php echo $image['thumb']; ?>" title="<?php echo !empty($image_title) ? $image_title : $heading_title; ?>" alt="<?= $heading_title; ?> - Фото-<?= ($img_indx + 1)?> Talan" />
										</a>
									</li>
									<?php endforeach; ?>
								<?php endif; ?>
					...
					<div class="large-image  <?php echo  (isset($thumbnails_position) && $thumbnails_position == 'left') ? ' vertical ' : '' ?> ">
						<img itemprop="image" class="product-image-zoom" src="<?php echo $popup; ?>" data-zoom-image="<?php echo $popup; ?>" title="<?php echo !empty($image_title) ? $image_title : $heading_title; ?>" alt="<?php echo !empty($image_alt) ? $image_alt : $heading_title; ?>" />
						<div class="box-label">
							<!--New Label-->
                    ...
                    <?php if ($images  && isset($thumbnails_position) && $thumbnails_position == 'bottom') : ?>
                        <div id="thumb-slider" class="<?php echo ((count($images) < 4 ) ? 'not_full_slider' : 'full_slider'); ?> <?php echo ($thumbnails_position == 'left' ? 'flexslider-large visible-xs' : 'owl-carousel'); ?>">
							...
							if ($images) : ?>
								<?php $i=-1; foreach ($images as $img_indx => $image) : $i++ ?>
									<a data-index="<?php echo $i; ?>" class="img thumbnail" data-image="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?> - Фото-<?= ($img_indx + 1)?> Talan">
										<img src="<?php echo $image['thumb']; ?>" title="<?php echo !empty($image_title) ? $image_title : $heading_title; ?>" alt="<?php echo $heading_title; ?> - Фото-<?= ($img_indx + 1)?> Talan" />
									</a>
								<?php endforeach; ?>
							<?php endif; ?>
			...
			<div class="content-product-right <?php if(isset($thumbnails_position) && $thumbnails_position == 'bottom') echo "info-right"; ?> <?php  echo $right_gallery; ?>">
				<div class="title-product">
					<h1 itemprop="name"><?= $h1 ? $h1 : $heading_title; ?></h1>
				</div>
				 <!-- Review ---->
				...
				<div class="product-label">
					...
					<div class="product_page_price price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">											 
				        ...
				        <?php if (!$special) { ?>
                        <span class="price-new"><span itemprop="price" id="price-old" content="<?php echo $price_value; ?>">
              <?php if ((isset($price_value) && (int)$price_value == 0) || (!isset($price_value) && (int)$price == 0)) { ?>
              <?php echo $text_no_price; ?>
              <?php } else { ?>
              <?php echo $price; ?>
              <?php } ?>
			</span><meta itemprop="priceCurrency" content="<?php echo $currency;?>" /></span>
                        <?php } else { ?>
                        <span class="price-new"><span itemprop="price" id="price-special" content="<?php echo $special_value; ?>"><?php echo $special; ?></span><meta itemprop="priceCurrency" content="<?php echo $currency;?>" /></span> <span class="price-old" id="price-old">
              <?php if ((isset($price_value) && (int)$price_value == 0) || (!isset($price_value) && (int)$price == 0)) { ?>
              <?php echo $text_no_price; ?>
              <?php } else { ?>
              <?php echo $price; ?>
              <?php } ?>
				...
				<div class="product-box-desc">
					...
					<?php } ?>
					<div class="stock"><span><?php echo $text_stock2; ?></span> <!--<i class="fa fa-check-square-o"></i> --><?php echo $stock; ?></div>			
				</div>

				<div class="short_description form-group short_desc" itemprop="description">
				...
				<div id="product">
					...
					<div class="options clearfix">
						<!--<div class="h3"><?php //echo $text_option; ?></div>-->
					...
					<div class="cart clearfix">
						...
						<div class="form-group box-info-product">
						    <div class="option quantity">
							  <div class="input-group quantity-control quantity_elem">
						    ...
						    <div class="detail-action detail_elem">
							   <!-- CART -->
							   <div class="cart cart_but">
