...
<div class="container product-detail">
    ...
    <div id="content" class="col-xs-12">
        <div class="product-view product-info product_block">
			<div class="content-product-left">
			
			<div class="product_block_title"><?php echo $heading_title; ?></div>
				...
				if ($images)  : ?>
					<div class="slider-for" >
						...
						if ($images) : ?>
							...
							<div class="contentslider--item">
								<a data-index="<?php echo $i; ?>" class="thumbnail" title="<?php echo !empty($image_title) ? $image_title : $heading_title; ?>">
									<img src="<?php echo $image['thumb']; ?>" title="<?php echo !empty($image_title) ? $image_title : $heading_title; ?>" alt="<?php echo !empty($image_alt) ? $image_alt : $heading_title; ?>" />
								</a>
							</div>
							<?php endforeach; ?>
						<?php endif; ?>
					...
					<div  class="slider-nav ">
						...
						<div class="slick-slide">
							<a data-index="<?php echo $i; ?>" class="img thumbnail"  title="<?php echo !empty($image_title) ? $image_title : $heading_title; ?>">
								<img src="<?php echo $image['thumb']; ?>" title="<?php echo !empty($image_title) ? $image_title : $heading_title; ?>" alt="<?php echo !empty($image_alt) ? $image_alt : $heading_title; ?>" />
							</a>
						</div>
						<?php endforeach; ?>
