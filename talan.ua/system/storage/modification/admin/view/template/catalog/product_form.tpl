    ...
    <div class="panel panel-default">
      ...
      <?php } ?>
            ...
            <li><a href="#tab-design" data-toggle="tab"><?php echo $tab_design; ?></a></li>
					...
					<!-- XD Stickers start -->
						<li><a href="#tab-xd_stickers" data-toggle="tab"><?php echo $tab_xd_stickers; ?></a></li>
					<!-- XD Stickers start -->
      ...
      <div class="tab-pane" id="tab-seo">
        <?php echo $seo_package_tab; ?>
				...
				<!-- XD Stickers start -->
					<div class="tab-pane" id="tab-xd_stickers">
					  <div class="table-responsive">
						<div class="form-group" style="margin: 0px">
						  <label class="col-sm-2 control-label" for="input-xd_stickers"><?php echo $entry_xd_stickers; ?></label>
						  <div class="col-sm-10">
							<div class="well well-sm" style="height: 150px; overflow: auto;">
								<?php foreach ($xd_stickers as $xd_sticker) { ?>
									<div class="checkbox">
										<label>
											<input type="checkbox" name="xd_stickers[][xd_sticker_id]" value="<?php echo $xd_sticker['xd_sticker_id'];?>" <?php echo (array_search($xd_sticker['xd_sticker_id'], $xd_stickers_product) !== false? "checked": "");?> /> <?php echo $xd_sticker['name']; ?>
										</label>
									</div>
								<?php } ?>
							</div>
