...
class ModelExtensionFeedNeoSeoProductFeed extends NeoSeoModel
{
	...
	public function install()
	{
		...
		$sql[] = "INSERT INTO `" . DB_PREFIX . "product_feed` (`language_id`, `feed_name`, `feed_shortname`, `status`, `id_format`, `use_main_category`, `use_warehouse_quantity`, `warehouses`, `use_categories`, `replace_break`, `not_unload`, `categories`,`manufacturers`
			,  `currency`,  `image_width`,`image_height`, `warranty`, `ip_list`, `sql_code`, `sql_code_before`, `use_original_images`, `products`) VALUES (" . (int) $this->config->get('config_language_id') . ",
		...
		$sql[] = "INSERT INTO `" . DB_PREFIX . "product_feed` (`language_id`, `feed_name`, `feed_shortname`, `status`, `id_format`, `use_main_category`, `use_warehouse_quantity`, `warehouses`, `use_categories`, `replace_break`, `not_unload`, `categories`,`manufacturers`
			...
			`image_height`, `warranty`, `ip_list`, `sql_code`, `sql_code_before`, `use_original_images`, `products`) VALUES (" . (int) $this->config->get('config_language_id') . ",
		...
		$sql[] = "INSERT INTO `" . DB_PREFIX . "product_feed` (`language_id`, `feed_name`, `feed_shortname`, `status`, `id_format`, `use_main_category`, `use_warehouse_quantity`, `warehouses`, `use_categories`,`replace_break`, `not_unload`, `categories`,`manufacturers`
			, `currency`,  `image_width`,
			`image_height`, `warranty`, `ip_list`, `sql_code`, `sql_code_before`, `use_original_images`, `products`) VALUES (" . (int) $this->config->get('config_language_id') . ",
			'FACEBOOK.COM', 'facebook_com', '0', '6','0' , '0' , '', '0' , '0', '' ,'" . join(",", $ids_categories) . "', '" . join(",", $ids_manufacturers) . "', '',    '600', '600', '12', '', '', '', '0', '');";

		$sql[] = "INSERT INTO `" . DB_PREFIX . "product_feed` (`language_id`, `feed_name`, `feed_shortname`, `status`, `id_format`, `use_main_category`, `use_warehouse_quantity`, `warehouses`, `use_categories`, `replace_break`, `not_unload`, `categories`,`manufacturers`
			,  `currency`,  `image_width`,`image_height`, `warranty`, `ip_list`, `sql_code`, `sql_code_before`, `use_original_images`, `products`) VALUES (" . (int) $this->config->get('config_language_id') . ",
			'ROZETKA.COM.UA', 'rozetka', '0', '1','0', '0' , '', '0' , '0', '' , '" . join(",", $ids_categories) . "', '" . join(",", $ids_manufacturers) . "', '',   '600', '600', '12', '', 'p.quantity > 0', '', '0', '');";

		$sql[] = "INSERT INTO `" . DB_PREFIX . "product_feed` (`language_id`, `feed_name`, `feed_shortname`, `status`, `id_format`, `use_main_category`, `use_warehouse_quantity`, `warehouses`, `use_categories`, `replace_break`, `not_unload`, `categories`,`manufacturers`
			,  `currency`,  `image_width`,`image_height`, `warranty`, `ip_list`, `sql_code`, `sql_code_before`, `use_original_images`, `products`) VALUES (" . (int) $this->config->get('config_language_id') . ",
			'GOOGLE MERCHANT', 'google_merchant', '0', '4','0', '0' , '', '0' , '0', '' , '" . join(",", $ids_categories) . "', '" . join(",", $ids_manufacturers) . "', '',   '600', '600', '12', '', 'p.quantity > 0', '', '0', '');";
		$sql[] = "INSERT INTO `" . DB_PREFIX . "product_feed` (`language_id`, `feed_name`, `feed_shortname`, `status`, `id_format`, `use_main_category`, `use_warehouse_quantity`, `warehouses`, `use_categories`, `replace_break`, `not_unload`, `categories`,`manufacturers`
			,  `currency`,  `image_width`,`image_height`, `warranty`, `ip_list`, `sql_code`, `sql_code_before`, `use_original_images`, `products`) VALUES (" . (int) $this->config->get('config_language_id') . ",
			'BESPLATKA.UA', 'besplatka_ua', '0', '7','0', '0' , '', '0' , '0', '' , '" . join(",", $ids_categories) . "', '" . join(",", $ids_manufacturers) . "', '',   '600', '600', '12', '', 'p.quantity > 0', '', '0', '');";
