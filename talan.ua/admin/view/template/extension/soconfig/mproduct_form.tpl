            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <?php if (isset($error_name[$language['language_id']])) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="product_description[<?php echo $language['language_id']; ?>][html_product_tab]" placeholder="<?php echo $entry_html_product_tab; ?>" id="input-html_product_tab<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['html_product_tab'] : ''; ?></textarea>
                        </div>
                    </div>
