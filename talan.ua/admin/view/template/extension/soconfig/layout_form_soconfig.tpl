			...
			<?php global $module_row;$module_row = 0; ?>
				...
				<div class="well"> 
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-12">
							<?php echo create_position('Header Block1 (Use in header 6)','header_block1',$layout_modules,$extensions,$module_row); ?>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-12">
				...
				<div class="well"> 
					<div class="row">
						...
						<div class="col-md-6 col-sm-6"> 
							<?php echo create_position('Content Top 1 (Used in Footer 3)','footer_top1',$layout_modules,$extensions,$module_row); ?>
						</div>
						...
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block3 (Used in Footer 3,4,5)','footer_block3',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block4 (Used in Footer 3)','footer_block4',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block5 (Used in Footer 4,5)','footer_block5',$layout_modules,$extensions,$module_row); 
							
							?>
						</div>
						<div class="col-md-6 col-sm-12"> 
							<?php echo create_position('Footer Block6 (Used in Footer 4)','footer_block6',$layout_modules,$extensions,$module_row); 
						...
						<div class="col-md-12 col-sm-12"> 
							<?php echo create_position('Footer Layout 6','footer_layout6',$layout_modules,$extensions,$module_row); ?>
						</div>
						<div class="col-md-12 col-sm-12"> 
							<?php echo create_position('Footer Layout 7','footer_layout7',$layout_modules,$extensions,$module_row); ?>
						</div>
						<div class="col-md-12 col-sm-12"> 
							<?php echo create_position('Footer Layout 8','footer_layout8',$layout_modules,$extensions,$module_row); ?>
						</div>
					 </div>
				</div>
          </fieldset>
