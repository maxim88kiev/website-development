								...
								<?php //--------------------------------------------------------------------------- ?>
									<div class="tab-pane" id="module">  <?php //<!-- General Options --> ?>
										...
										<div class="form-group"> 
											<label class="col-sm-3 control-label" for="input-open_link"> <span data-toggle="tooltip" title="<?php echo $objlang->get('Type Layout'); ?>"><?php echo $objlang->get('Type Layout'); ?> </span></label>
											<div class="col-sm-9">
												<div class="col-sm-5">
