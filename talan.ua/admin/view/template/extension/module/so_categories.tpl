						...
						<div class="tab-pane">
							...
							<?php //----------------------------------------------------------------------- ?>
								<div class="tab-pane" id="category_option"> <?php // <!--Category Option --> ?>
									...
									<div class="form-group"> <?php // <!--Show Image Description --> ?> 
										<label class="col-sm-3 control-label" for="input-cat_all_product">
											<span data-toggle="tooltip" title="<?php echo $objlang->get('entry_cat_desc'); ?>"><?php echo $objlang->get('entry_cat_desc'); ?></span>
										</label>
										<div class="col-sm-9">
											<div class="col-sm-5">
												<label class="radio-inline">
													<?php if ($module['cat_desc']) { ?>
													<input type="radio" name="cat_desc" value="1" checked="checked" />
													<?php echo $objlang->get('text_show'); ?>
													<?php } else { ?>
													<input type="radio" name="cat_desc" value="1" />
													<?php echo $objlang->get('text_show'); ?>
													<?php } ?>
												</label>
												<label class="radio-inline">
													<?php if (!$module['cat_desc']) { ?>
													<input type="radio" name="cat_desc" value="0" checked="checked" />
													<?php echo $objlang->get('text_hide'); ?>
													<?php } else { ?>
													<input type="radio" name="cat_desc" value="0" />
													<?php echo $objlang->get('text_hide'); ?>
													<?php } ?>
												</label>
											</div>
