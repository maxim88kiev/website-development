                ...
                <?php foreach ($banner_images[$language['language_id']] as $banner_image) { ?>
                  <tr id="image-row<?php echo $image_row; ?>">
                    <td class="text-left" style="width: 40%;">
                        <textarea name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][banner_image_description]" placeholder="<?php echo $entry_title; ?>" class="form-control banner-image-description input-description<?php echo $language['language_id'] .'-' .$image_row; ?>" rows=10 ><?php echo isset($banner_image['banner_image_description']) ? $banner_image['banner_image_description'] : ''; ?></textarea>
...
$('.tab-content').on('focus', '.banner-image-description', function(){
  <?php foreach ($languages as $language) { ?>
    $('.banner-image-description').each(function(){
...
function addImage(language_id) {
  ...
  html += '  <td class="text-left" style="width: 40%;">';
	html += '    <textarea type="text" name="banner_image[' + language_id + '][' + image_row + '][banner_image_description]" placeholder="<?php echo $entry_title; ?>" class="form-control banner-image-description input-description' + language_id + '-' + image_row + '" rows=10 /></textarea>';
	html += '  </td>';	
