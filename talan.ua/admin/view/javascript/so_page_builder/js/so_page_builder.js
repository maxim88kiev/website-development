(function($) {
	...
	function editWidget(mod){
		...
		$(".so-page-wedit",mod).bind( 'click', function(){
			...
			if(type=="module"){
				var html  = '<iframe id="ifmEditModule" src="'+$(this).data('href').replace(/http/gi, 'https')+'" style="padding:0; margin: 0; display: block; width: 100%; height: 100%;" frameborder="no" scrolling="auto"></iframe>';
				$( "#edit_module" ).modal({
					backdrop :"static",
					keyboard :false
				});
