...
class ControllerExtensionFeedNeoSeoProductFeed extends NeoSeoController
{
	...
	public function index()
	{
		...
		$data = $this->initBreadcrumbs(array(
			array('extension/extension', "text_feed"),
		...
		foreach ($results as $id => $feed) {
			$item = array(
				...
				'feed_cron' => rtrim(HTTP_CATALOG, "/") . "/index.php?route=extension/feed/" . $this->_moduleSysName . "/download&feed=" . $feed["feed_shortname"]. ".xml",
				'feed_cron_link' => rtrim(HTTP_CATALOG, "/") . "/system/storage/download/" . $feed["feed_shortname"] . ".xml",
		...
		$data['default_formats'] = $this->url->link('extension/feed/' . $this->_moduleSysName . '/defaultFormat', 'token=' . $this->session->data['token'], 'SSL');
