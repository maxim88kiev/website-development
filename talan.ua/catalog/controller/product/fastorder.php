...
// =================================================================================================
        ...
        // Language data
        $data['text_fastorder_firmname']                    = $this->language->get('text_fastorder_firmname');
        $data['text_fastorder_firmname_placeholder']        = $this->language->get('text_fastorder_firmname_placeholder');
        $data['text_fastorder_button']                      = $this->language->get('text_fastorder_button');
        $data['text_fastorder_form_header']                 = $this->language->get('text_fastorder_form_header');
        $data['text_fastorder_form_info']                   = $this->language->get('text_fastorder_form_info');
        $data['text_fastorder_name']                        = $this->language->get('text_fastorder_name');
    ...
    public function sender(){
        ...
        $data['text_fastorder_mail_msg_firmname']   = $this->language->get('text_fastorder_firmname');
        ...
        if (isset($this->request->post['firmname'])){
          $json['firmname'] = $this->request->post['firmname'];
        }
        ...
        $mail_tmpl_data = array (
            ...
            'text_fastorder_mail_msg_firmname'  => $data['text_fastorder_mail_msg_firmname'],
