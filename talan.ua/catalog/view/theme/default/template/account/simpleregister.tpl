...
.breadcrumb{
	background-color: #538c75 !important;
	color: #fff
}
...
.simpleregister-block-content .form-horizontal .form-group div{
	padding: 0;
	max-width: 300px;
}

.simpleregister-block-content .form-horizontal .form-group div .checkbox{
	margin-left: 21px;
}

.simpleregister-block-content .form-horizontal .form-group div input{
	border: 2px solid rgb(83, 140, 117);
	background-color: rgb(255, 255, 255);
	font-size: 14px;
}

.simpleregister-block-content .form-horizontal .form-group div select{
	border: 2px solid rgb(83, 140, 117);
	background-color: rgb(255, 255, 255);
	font-size: 14px;
}
