	...
	<div class="footer-top">
		<div class="container content">
			...
			<div class="box-footer1 contact-us">
				<?php echo str_replace(['<h3 class="modtitle">', '</h3>'], ['<div class="modtitle h3">', '</div>'], $footer_block3); ?>
			</div>

			<!-- BOX ACCOUNT -->
			<div class="box-account box-footer">
				<div class="module clearfix">
					<div class="modtitle _h3"><?php echo $text_account; ?></div>
			...
			<div class="box-information box-footer">
				<div class="module clearfix">
					<div class="modtitle _h3"><?php echo $text_information; ?></div>
					<div  class="modcontent" >
						<ul class="menu">
			...
			<div class="box-service box-footer">
				<div  class="modcontent" >
					<div class="modtitle _h3"><?php echo $text_service; ?></div>
			        <ul class="menu">
			       ...
			       <!--   <li><a href="<?php echo $return; ?>"><?php echo $text_return; ?></a></li>  -->
			        ...
			        <div class="footer-socials">
				    	<a href="https://www.facebook.com/talansafety/" target="_blank"><img src="https://talan.ua/image/catalog/icons/fb.png" width="50" alt="FaceBook"></a>
				    	<a href="https://www.youtube.com/channel/UCDtnwGxrf0-VVwvtSkhNeGQ/videos" target="_blank"><img src="https://talan.ua/image/catalog/icons/yout.png" width="50" alt="YouTube"></a>
				    </div>
			    </div>
		    </div>		
