...
?>
<!-- BREADCRUMB -->
<div class="breadcrumbs category_br">
	<div class="container">
...
<div class="category_bg_img">

	<?php echo $content_bottom; ?>
	<!--<img src="/image/catalog/talan_img/wsdewed.jpg" alt="category_bg_img" title="category_bg_img" />-->
</div>
<div class="container product-listing content-main cont_block">
    ...
    <div id="content" class="<?php echo $class; ?>">
        ...
        <div class="products-category">
			...
			?>
			<!--<h1 class="title-category" style="display: block;"><?//= /*$h1 ? $h1 : */$heading_title; ?></h1>-->
