<div class="responsive megamenu-style-dev <?php echo $ustawienia['suffix_class']; ?>">
    ...
    <nav class="navbar-default">
        <div class=" container-megamenu  <?php if ($ustawienia['orientation'] == 1) {
            echo 'vertical ';
        } else {
            echo 'horizontal';
        } ?>">
            <?php if ($ustawienia['orientation'] == 1) { ?>
                <div id="menuHeading" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                     aria-expanded="true">
            ...
            <div class="vertical-wrapper" aria-labelledby="menuHeading">
                ...
                <div class="megamenu-wrapper">
                    ...
                    <div class="megamenu-pattern">
                        <!-- <div class="container"> -->
                        <ul class="megamenu"
                            data-transition="<?php if ($ustawienia['animation'] != '') {
                                echo $ustawienia['animation'];
                            } else {
                                echo 'none';
                            } ?>"
                            data-animationtime="<?php if ($ustawienia['animation_time'] > 0 && $ustawienia['animation_time'] < 5000) {
                                echo $ustawienia['animation_time'];
                            } else {
                                echo 500;
                            } ?>">
                                ...
                                <li class="home">
                                    <a href="<?php echo $home; ?>">
                                        <?php if ($ustawienia['home_item'] == 'icon') { ?>
                                            ...
                                            echo '<span><span class="_b">' . $home_text . '</span></span>';
                                        } ?>
                                    </a>
                                </li>
                            <?php } ?>
                                            ...
                                            if ($submenu['content_type'] == '0') {
                                                ...
                                                if (isset($submenu['productlist']['products']) && $submenu['productlist']['products']) {
                                                    foreach ($submenu['productlist']['products'] as $product) {
                                                        ...
                                                        echo '<div class="h4"><a href="' . $product['href'] . '">' . $product['name'] . '</a></div>';
