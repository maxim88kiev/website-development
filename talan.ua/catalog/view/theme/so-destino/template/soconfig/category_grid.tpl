<?php if ($products) { ?>
	<!-- Filters -->
	<div class="product-filter filters-panel filters_block">
	  <div class="row">
		<div class="box-list col-md-2 hidden-sm hidden-xs">
			<div class="view-mode">
				<div class="list-view">
					<button class="but_large grid <?php if($listingType =='grid') { echo 'active'; } ?>"  data-toggle="tooltip" title="<?php echo $button_grid; ?>"></button>
					<button class="but_bars list <?php if($listingType =='list') { echo 'active'; } ?>"  data-toggle="tooltip" title="<?php echo $button_list; ?>"></button>
				</div>
			</div>
		</div>
