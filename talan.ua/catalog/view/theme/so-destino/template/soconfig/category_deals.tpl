				...
				<div class="row">
					...
					<div class="right-block col-lg-8 col-md-6 col-sm-7 col-xs-12">
						<div class="caption">
						  ...
						  <div class="clearfix">
							<button class="btn btn-default addToCart" type="button" data-toggle="tooltip" title="<?php echo $button_cart; ?>" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><i class="fa fa-shopping-cart"></i> <span><?php echo $button_cart; ?></span></button>
							...
							<button class="btn btn-default compare" type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-random"></i></button>
						  </div>
					</div><!-- right block -->
				</div>	
			</div>
