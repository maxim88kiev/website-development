...
$_['text_stock2']                              = 'Наличие:';
$_['text_instock']                            = 'Есть в наличии';
$_['product_description_short']		      = 'Описание';
$_['product_socialshare']		      = 'Поделиться через';
$_['text_sharethis']		              = 'Поделиться через';
$_['text_tax']                                = 'Без НДС:';
...
$_['text_month']                              = 'месяц';
$_['text_year']                               = 'год';
$_['text_no_price']            = '<a href="%s">Под заказ</a>';
$_['text_retail']			   = 'Розничная цена';
$_['text_wholesale']		   = 'Оптовые цены узнавайте по соответствующему телефону';
// Entry
