...
function twentynineteen_scripts() {
    ...
    wp_enqueue_script( 'twentynineteen-keis', get_theme_file_uri( '/js/keis.js' ), array(), '1.1', true );
}
...
function ajax_form(){
    ...
    $msg = "
         Адрес сайта: ".$domen."<br/>
         Ссылки на продвигаемые категории: ".$urls ."<br/>
         Желаемые результаты : ".$uslugi ."<br/>
         Возраст сайта : ".$age ."<br/>
         Комментарии: ".$comments ."<br/>";
    $mail_to = 'maxim88kiev@gmail.com';
